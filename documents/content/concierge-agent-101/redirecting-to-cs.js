...
Images Won’t Load
If images sent by the customer don’t load after two tries
1
Two tries = you’ve asked the customer to resend twice, regardless of how many photos were sent
2
If images are essential for resolution and still not working. Send the customer to CS
...
How to Escalate
Don’t just copy and paste the customer or agent messages into the escalation note. Summarize and explain the situation instead
Keep in mind
Ask the customer for the required information based on the type of escalation and let them know you are reaching out to the team. If no information is needed, we can simply escalate 
1
Once the customer provides the necessary information, proceed to escalate before sending your message
2
Click Escalate and write a clear internal note for the brand's CS team and include all required information gathered in the note
3
...
Full Name
Shipping Address
Once all required details are provided, you can proceed with the escalation
If we need to escalate an issue and require the customer’s email address
1
If the customer is unable to provide their email or order number tied to their order
2
...
If another agent has already escalated the issue, don’t remove it just because you believe it might still be solvable. We will review when it’s okay to de-escalate shortly
Keep in Mind
...
1
There is no longer any pending concern
2
The customer confirms their response has been handled by CS 
3
