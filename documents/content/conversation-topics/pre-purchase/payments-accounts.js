...
Inability to Log In
When a customer reports they’re unable to log in, we follow a structured process to quickly identify and resolve the root cause. Here's how we typically troubleshoot:
1
2
Ask for a Screenshot of the Error
Advise a Password Reset
Ask Them to Check Spam and Promo
Suggest a Different Browser or Device
This helps us see exactly what they see, which often reveals the nature of the issue
If no system-level error is shown, ask the customer to use the “Forgot Password” link
Many recovery emails end up here due to filtering 
If issue persists, suggest using another browser, switching to incognito mode, or trying another device
...
In the Agent UI, we often display a customer’s name tied to their email address
However, the name typically captured during sign-up for SMS may not always be accurate
Bonus!

Name Changes
How We Resolve Name Change Requests
If the issue should be handled by escalation
In case the customer didn’t already provide a name ask them to confirm their real name
Escalate the issue to the team 

Empathize With the Customer
Apologize for the mix-up and let them know that we’ll look into resolving the issue
Empathize With the Customer
Escalate
