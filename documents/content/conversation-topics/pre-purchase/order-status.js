...
If their provided information suggests the order should have processed/shipped/arrived by now:
                                                   ...
                                                   5. Escalate the issue or direct to Customer Support (cs) as per brand notes, providing all details the customer shared.
...
These scenarios require careful attention to brand-specific notes and empathy.
                                                            1. Super Delayed Orders (Confirmed orders, including Pre-Orders/Backorders):
                                                               ...
                                                               4. Communicate Findings: Share any available ETA.

                                                               5. If no estimated time is mentioned (past or present) or if the delay is excessive beyond any provided estimate: Escalate or send to CS based on the brand notes.
...
If you checked the status of the order and you see that the label has been created and there’s no movement for a long while, refer to this document: [EDIT VERSION] Missing/Lost Items
