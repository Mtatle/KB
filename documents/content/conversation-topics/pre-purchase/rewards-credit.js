// Rewards and Credit - Conversation Topics > Pre-Purchase
window.documentRegistry = window.documentRegistry || {};
window.documentRegistry["1PhOw3LF0aNbJLyWFDBVaZTe2AiTxwrgbqZfSJfCHjuI"] = {
    ...
    tags: ["rewards", "credit", "pre-purchase", "customer service"],
    description: "Guide for handling rewards and credit inquiries",
...
1. Store Credit Code Not Working
   * Ask for a screenshot of the error they see at checkout and a screenshot of the email/source of the store credit to verify the code and any (rare) T&Cs. Check and conditions and exclusions too and share them. Remember: Store credits usually don't have cart minimums like discount codes.
   * Check Code Entry: Ensure they are typing it correctly.
   * Basic Troubleshooting: Suggest using incognito window (send 'sww' template if applicable).
...
Endorsing a brand’s rewards program
...
1. Gift Card Code Not Working
   * Check Code Entry: Share any conditions and exclusions & verify the code is being entered exactly as shown (case sensitivity might matter). Ask for a screenshot if possible.
   * Error Message: Ask for the specific error message and the items they’re trying to use it on. ("Invalid code" vs "Zero balance").
