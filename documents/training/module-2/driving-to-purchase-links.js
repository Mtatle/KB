...
const drivingToPurchaseContent = {
    ...
    type: 'presentation',
    description: 'Training module on driving customers to purchase and managing links',
    tags: ['training', 'module2', 'purchase', 'links', 'conversion'],
...
Whenever we provide the customer with a discount code or similar offer, we would redirect the customer to a specific product page or collection so they can make use of the discount
...
Depending on what needs to be shared, you can include screenshots or mention the product name to clarify

Correct Region
Check if the URL contains a region code (e.g., "us" in www.brand.com/us/)

Some links may default to a specific country version of the site
Check the URL
Change the region manually on the brand's website

This is usually found in the header or footer
Check the Region
To ensure a link is correctly filtered for the right region, there are two key steps we should take to double-check
...
Best Practices
Use the Funnel Method to narrow down their preferences:
...
Any colors, logos, or other design details
...
if (window.documentRegistry) {
    window.documentRegistry.registerDocument(drivingToPurchaseContent, 'training', 'module2');
} 