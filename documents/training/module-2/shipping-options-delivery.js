...
const shippingOptionsContent = {
    ...
    type: 'presentation',
    description: 'Training module on shipping options and delivery processes',
    tags: ['training', 'module2', 'shipping', 'delivery', 'options'],
...
if (window.documentRegistry) {
    window.documentRegistry.registerDocument(shippingOptionsContent, 'training', 'module2');
} 