// Document content for Performance Tracking & Support Tools
const performanceTrackingContent = {
    id: '1olKxtscaFT702gQyDccRJ_m3MYW6iaqyW3Oo9rmzjJ4',
    title: 'Performance Tracking & Support Tools',
    type: 'presentation',
    description: 'Training module on performance tracking and support tools',
    tags: ['training', 'module1', 'performance', 'tracking', 'support', 'tools'],
...
if (window.documentRegistry) {
    window.documentRegistry.registerDocument(performanceTrackingContent, 'training', 'module1');
} 