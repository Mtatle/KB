// Document content for When to Mark as Do Not Respond
const doNotRespondContent = {
    id: '1rARWcKeZKqv-h_y-uiYrUDyhhtf0Iy8SnqLr_audy_U',
    title: 'When to Mark as Do Not Respond',
    type: 'presentation',
    description: 'Training module on when to mark conversations as do not respond',
    tags: ['training', 'module1', 'do-not-respond', 'conversation-management'],
...
if (window.documentRegistry) {
    window.documentRegistry.registerDocument(doNotRespondContent, 'training', 'module1');
} 