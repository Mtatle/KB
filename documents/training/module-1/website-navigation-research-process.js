// Document content for Website Navigation & Research Process
const websiteNavigationContent = {
    id: '1vqhJEJKPffTT8I5z2anpyVHpqMc-GHXe9U79zgdZfrk',
    title: 'Website Navigation & Research Process',
    type: 'presentation',
    description: 'Training module on website navigation and research processes',
    tags: ['training', 'module1', 'website', 'navigation', 'research', 'process'],
...
if (window.documentRegistry) {
    window.documentRegistry.registerDocument(websiteNavigationContent, 'training', 'module1');
} 