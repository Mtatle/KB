const textBlazeContent = {
    ...
    type: 'presentation',
    description: 'Guide on how to use TextBlaze for text expansion and automation',
    tags: ['textblaze', 'tools', 'automation', 'system', 'training'],
...
if (window.documentRegistry) {
    window.documentRegistry.registerDocument(textBlazeContent, 'admin', 'system');
} else {
    console.log('Document registry not available, queuing document for registration');
    window.addEventListener('registryReady', () => {
        window.documentRegistry.registerDocument(textBlazeContent, 'admin', 'system');
    });
}
