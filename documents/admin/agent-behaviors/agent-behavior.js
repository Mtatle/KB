...
KPIs
 ...
 KPIs  
What do you think these KPIs measure in your performance?
Closed Chats
Opt Out
Block List
SPH
...
Use templates, review chat history, and avoid errors to achieve and maintain the 92% target
...
Availability
Availability is the percentage of time clocked into When I Work that was spent in the available state on the agent platform. It is caused by disabled availability to avoid a conversation.  
...
Not using the emergency workflow to let us know you won’t be able to attend your shift
        Definition
The number of shifts that were not attended
100% Compliance
       Target
...
And if you work more than 8 hours, you can’t take your full break at once you must split it. The maximum break length allowed is 30 minutes
...
Report issues anytime, but you will receive replies Mon-Fri around 11 AM, 3 PM, & 7 PM
A customer was promised a discount code, but none is available
A customer claims they never received their welcome code
The brand persona is missing
Ops Issues are:
...
Next Steps 
🎉🎉 Drumroll, please... 🥁 Get ready for the next Training Session, this one’s all about Website Navigation & The Research Process📝
